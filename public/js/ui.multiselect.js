...
$.widget("ui.multiselect", {
  options: {
	...
	_create: function() {
		...
		this.container = $('<div class="ui-multiselect ui-helper-clearfix ui-widget editlinkageedit "></div>').insertAfter(this.element);
		this.count = 0; // number of currently selected options
		this.selectedContainer = $('<div class="selected card z-depth-3"></div>').appendTo(this.container);
		this.availableContainer = $('<div class="available card z-depth-3 availablecardedit" style="margin-top: -101%;margin-left: 109%;"></div>')[this.options.availableFirst?'prependTo': 'appendTo'](this.container);
